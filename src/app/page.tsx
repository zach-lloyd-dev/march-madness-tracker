    ...
    <div className="ambient-bg min-h-screen">
      ...
      <main className="flex-1 max-w-3xl mx-auto w-full px-4 py-8 relative z-10">
        ...
        <footer className="mt-12 pt-6 border-t border-white/5 pb-8 text-center text-xs text-gray-500 space-y-2">
          {lastUpdated && (
            <p>Last updated: {new Date(lastUpdated).toLocaleTimeString("en-US", { hour: "numeric", minute: "2-digit", second: "2-digit", timeZoneName: "short" })}</p>
          )}
          ...
          <div className="flex items-center justify-center gap-4 mt-4 text-gray-400">
            <a href="https://skool.com/zero-to-automated" target="_blank" rel="noopener noreferrer" className="hover:text-[#4a90e2] transition-colors">Zero to Automated Community</a>
            <span className="text-gray-600">|</span>
            <a href="https://youtube.com/@blacksheepsystems" target="_blank" rel="noopener noreferrer" className="hover:text-[#4a90e2] transition-colors">YouTube</a>
          </div>
